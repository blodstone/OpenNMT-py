...
python train.py -save_model $MODEL/topic-bbc-1024-ws-025ah -data $DATA -global_attention mlp -word_vec_size 256 -rnn_size 1024 -layers 2 -encoder_type brnn -train_steps 200000 -max_grad_norm 2 -dropout 0. -batch_size 16 -valid_batch_size 16 -optim adagrad -learning_rate 0.15 -adagrad_accumulator_init 0.1 -seed 777 -sample weighted -fusion average -topic_psi 0.25 -topic_matrix $DATA/topic_matrix.tensor -lemma-align $DATA/src.train.pair -bridge -world_size 1 -gpu_ranks 0 -log_file $OUTPUT/topic-bbc-1024-ws-025ah-01.log
