...
from onmt.inputters.topic_dataset import DocTopicDataReader
...
__all__ = ['Dataset', 'load_old_vocab', 'get_fields', 'DataReaderBase',
           ...
           'TextDataReader', 'ImageDataReader', 'AudioDataReader', 'DocTopicDataReader']
